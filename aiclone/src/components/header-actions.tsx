          ...
          <span className="relative text-xl sm:text-2xl cursor-pointer px-4 py-1 transition-all duration-300 group overflow-hidden">
            ...
            `}
                ...
                <div className="flex gap-4">
                    <Link href="/login">
                        <button className="relative overflow-hidden rounded-full px-6 py-2 cursor-pointer text-black text-lg font-semibold bg-white group transition-all duration-300">
