  ...
  return (
    ...
    <section className="flex flex-col md:flex-row mx-auto max-w-[96rem] items-center justify-between gap-12 py-20 px-4 lg:px-24  ">
      <div className="flex-1 animate-slide-left ">
        ...
        <p className="text-gray-500 text-lg mb-4 animate-fade-in delay-200">
          Unlock access to top AI models like ChatGPT-4, Claude 3, Mistral, and more — all under one powerful subscription.
        </p>
        <p className="text-gray-500 text-md mb-6 animate-fade-in delay-400">
      ...
      <div className="flex-1 animate-scale-up flex justify-center">
        <Image
          ...
          width={450}
          height={450}
          className="rounded-4xl shadow-xl hover:scale-105 transition-transform duration-500 hidden md:block"
        />
      </div>
    </section>
...
const FeatureCard = ({ icon, title, desc }: { icon: string; title: string; desc: string }) => (
  <div className="bg-white dark:bg-gray-900 text-black dark:text-white p-6 rounded-xl shadow-lg hover:shadow-blue-500/40 hover:scale-105 transition-transform duration-300 cursor-pointer animate-fade-in-up">
...
// ----- CTASection -----
const CTASection = () => (
  <section className="mx-auto max-w-[96rem] text-center mt-32 ">
...
const AskAIPromoPage = () => {
  return (
    <main className=" dark:text-white text-black px-6 md:px-24 py-16">
      <HeroSection />
      <FeatureGrid />
      <CTASection />
    </main>
