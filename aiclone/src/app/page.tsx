    ...
    <div className="min-h-screen mx-auto max-w-[96rem]">
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button onClick={()=>router.push('/signup')} className="px-8 py-3  text-blue-600 rounded-md hover:bg-gray-100 font-medium">
            Sign Up Free
          </button>
          <button className="px-8 py-3 border  rounded-md hover:bg-blue-700 font-medium">
            Contact Our Team
          </button>
        </div>
        </div>
